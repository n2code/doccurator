...
func PromptUser(request string, options []string, cleanup bool) (choice string) {
...
func AutoChooseDefaultOption(request string, options []string, cleanup bool) string {
